  ...
  head: () => ({
    meta: [
      ...
      { title: "Echo 27 — Growth Marketing Agency" },
      {
        name: "description",
        content:
          "Echo 27 is a Toronto growth marketing agency running paid ads, web and UX design, funnel building, and fractional CMO work for founders who want revenue, not reports.",
      },
